...
export default class BouncingLogo
{
    ...
    setModel()
    {
        ...
        this.model.texture = this.resources.items.IDPIC
    ...
    setAnimation()
    {
        ...
        this.animations.limits.z = { min: -0.9, max: 1.3 }
        this.animations.limits.y = { min: -0.8, max: 0.7 }

        this.animations.speed = {}
        this.animations.speed.z = 0.005
        this.animations.speed.y = 0.005
